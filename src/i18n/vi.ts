export default {
  ...
  about: {
    ...
    users: 'Người chơi',
    games: 'Trò chơi',
    twentyFourHour: 'Truy Cập 24/7',
    twentyFourHourContent: `Đảm bảo hoạt động kinh doanh của các nhà khai thác hoạt động trơn tru suốt cả năm. `,
    design: 'Thiết Kế',
    designContent:
  ...
  footer: {
    address: 'Địa chỉ',
    address01: 'Valletta Buildings, South Street, Valletta - VLT 1103 Malta, Mỹ',
    address02: 'Số 20 đường Phan Đăng Lưu, quận Hải Châu, thành phố Đà Nẵng, Việt Nam',
    subscribe: 'Theo dõi',
    subscribeContent:
